...
public class Query {
    ...
    static ArrayList<NewsData> fetchingData(String url) {
    ...
    private static final String LOG = Query.class.getSimpleName();
    ...
    private static ArrayList<NewsData> extractNews(String jsonRes) {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                news.add(
                        new NewsData(sectionName, webTitle, author, date, pageURL));
